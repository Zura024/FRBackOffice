...
class ChangePasswordModel{
    ...
    function changePassword($pass)
    {
        ...
        if (!preg_match('/^[a-zA-Z0-9]{5,}$/', $password->new_pass) || !preg_match('/^[a-zA-Z0-9]{5,}$/', $password->old_pass) || !preg_match('/^[a-zA-Z0-9]{5,}$/', $password->confirm_pass)) {
            $response = (object)array('desc' => "Incorrect Format", "statusCode" => 3);
        } else {
